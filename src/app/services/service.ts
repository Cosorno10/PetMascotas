...
export class Service {
  ...
  protected putApi = (url: string, params: any = {}, headers = {}) => {
    return this.http.put(env.apiUrl + url, params, headers).pipe(timeoutWith(720000, 'timeout exceeded'), map(r => r), catchError(this.handleError));
  };

  protected deleteApi = (url: string, params: any = {}, headers = {}) => {
    return this.http.delete(env.apiUrl + url, params).pipe(timeoutWith(720000, 'timeout exceeded'), map(r => r), catchError(this.handleError));
  };
